      ...
      <div className="mt-12 space-y-8">
        <section className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm">
          ...
          <div className="text-slate-600 leading-relaxed space-y-4">
            <p>
              <strong>JSON(JavaScript Object Notation)</strong>은 데이터를 저장하고 전송할 때 가장 많이 사용되는 가벼운 형식입니다. 
              하지만 서버에서 받아온 데이터나 로그 파일의 JSON은 종종 한 줄로 길게 늘어져 있어 사람이 읽기 매우 어렵습니다.
            </p>
            <p>
              본 도구는 그렇게 읽기 힘든 '민감한' 데이터를 <strong>Pretty Print</strong> 형식으로 변환하여, 데이터 구조를 한눈에 파악할 수 있도록 돕습니다. 
              개발자, 데이터 분석가, 그리고 API 테스트를 진행하는 모든 분들에게 필수적인 도구입니다.
            </p>
          </div>
        </section>
          ...
          <Card className="bg-blue-50/50 border-none shadow-none">
            <CardContent className="pt-6">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                입력하신 모든 데이터는 <strong>사용자의 브라우저 내에서 실시간으로 처리</strong>됩니다. 
                서버로 데이터를 전송하거나 외부에 기록을 남기지 않으므로, API 키나 개인정보가 포함된 
                중요한 JSON 데이터도 안심하고 정렬하실 수 있습니다.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <section className="p-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-slate-600">A: JSON은 작은따옴표(') 대신 반드시 큰따옴표(")를 사용해야 하며, 마지막 요소 뒤에 콤마(,)가 찍혀있지 않은지 확인해 보세요.</p>
            </div>
            <div>
              <h4 className="font-semibold text-slate-700">Q: 데이터 크기 제한이 있나요?</h4>
              <p className="text-sm text-slate-600">A: 브라우저의 성능에 따라 수 메가바이트(MB) 수준의 대용량 데이터도 즉시 처리가 가능합니다.</p>
            </div>
          </div>
        </section>
      </div>
